...
?>
   	<form action="cart.php" method="post">
	   	...
	   	<input type="submit" class="btn btn-primary" name="save_change" value="Salveaza modificari">
	</form>
	<br/><br/>
	<a href="checkout.php" class="btn btn-primary">Mergi la Checkout</a> 
	<a href="books.php" class="btn btn-primary">Continua Cumparaturile</a>
<?php
	} else {
		echo "<p class=\"text-warning\">   Cosul tau este gol. Asigura-te ca ai adaugat carti in el. </p>";
	}
