<?php
	...
	session_unset();
?>
	<p class="lead text-success">Comanda ta a fost procesata cu succes. Te rog verifica-ti emailul pentru confirmare!. 
	Cosul tau e din nou gol.</p>
